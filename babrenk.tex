...
Bei der ZVO sollen jährlich händisch aufgenommene Anfragen in Zukunft maschinell klassifiziert werden. Für die korrekte Klassifikation ist die Qualität der vorliegenden Daten immens wichtig. Die Qualität der ZVO Daten werden in dieser Arbeit untersucht. Dafür wird ein LDA Modell generiert, das als Datengrundlage alle verfügbaren ZVO Daten verwendet. Der Algorithmus durchläuft dafür folgende Schritte: \\

% FLOW CHART %%%%%%%


\begin{algorithm}[H]
\KwData{Alle ZVO Daten}
\KwResult{LDA Modell}
initialization\;
data = ""\;
\For {Anzahl Dokumente} \Do
	{Füge Dokumentinhalt zu data hinzu}\;
...
\section{Ein großer Korpus \textcolor{red}{Groppe}}
